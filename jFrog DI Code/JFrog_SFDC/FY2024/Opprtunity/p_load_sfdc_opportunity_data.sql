...
INSERT into Delta(TableName='delta.opp_clean_pstg_order_item', Overwrite=true, Unlogged=true)
  select * from delta.pstg_order_item_final

s_delete_opp_expiring_arr_pstg_order_item
delete from delta.pstg_order_item_final where order_code in (
select order_code from delta.pstg_order_item_final having count(*)>1
